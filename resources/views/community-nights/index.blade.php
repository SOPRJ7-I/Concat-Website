            ...
            @foreach($communityNights->sortByDesc('created_at') as $communityNight)
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-5">
                        ...
                        <a href="{{ route('community-nights.show', $communityNight) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center bg-red-500 text-white hover:bg-red-600 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300">
                            Meer lezen
